...
public class Tensor {
	...
	// hashmaps entre 2 objetos, temos que ter um objeto que nos da a relação engre
	// as duas col
	...
	private static String buildId(int line, int column) { // pode ser static porque nao faz nada ao tensor, o
															// comportamento vai ser igual para todas as instancias da
															// classe tensor
