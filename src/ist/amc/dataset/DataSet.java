...
public class DataSet implements Serializable {
	...
	public DataSet(String csvFile) {
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				dataList.add(convert(line)); // add no array list - os arrays sao tipos basicos. o arraylist é uma
	...
	// temos um objeto que é um arraylist que tem vários arrays de inteiros lá
	// dentro

	// pega em line (em string) e com split pega nos separadores e faz um array dos
	// valores divididos em virgulas
	// converto em arrays de string e depois faço arrys de Integers
	// a função recebe uma string, faz o slit faz com que fiqye array de strings,
	// depois varro o array de strings e torno o em array de inteiros e guardo isso
	// no array inteiro
